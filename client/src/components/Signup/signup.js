              ...
              <Form id="reg-form" onSubmit={this.submitHandler}>
                <Row>
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="firstname">
                        First Name
                      </Label>
                      <Input
                        type="input"
                ...
                <Row>
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="email">
                        Email
                      </Label>
                      <Input
                        type="email"
                  ...
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="repeatemail">
                        Confirm Email
                      </Label>
                      <Input
                        type="email"
                ...
                <Row>
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="password">
                        Password
                      </Label>
                      <Input
                        type="password"
                  ...
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="password_con">
                        Confirm Password
                      </Label>
                      <Input
                        type="password"
                ...
                <Row>
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="phoneone">
                        Contact No. 1
                      </Label>
                      <Input
                        type="input"
                  ...
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="phonetwo">
                        Contact No. 2
                      </Label>
                      <Input
                        type="input"
                ...
                <Row>
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="addrone">
                        Address Line 1
                      </Label>
                      <Input
                        type="input"
                  ...
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="addrtwo">
                        Address Line 2
                      </Label>
                      <Input
                        type="input"
                ...
                <Row>
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="city">
                        City
                      </Label>
                      <Input
                        type="input"
                  ...
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="addrstate">
                        State
                      </Label>
                      <br />
                      <select
                        className="dropdown-list label-white btn-outline-light"
                        id="addrstate"
                        name="addrstate"
                        onChange={this.changeHandler}
                      >
                  ...
                  <Col className="col-12">
                    <FormGroup>
                      <Label className="label-white" for="zip">
                        Zip Code
                      </Label>
                      <Input
                        type="input"
